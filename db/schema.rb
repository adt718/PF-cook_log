...
ActiveRecord::Schema.define(version: 20_210_214_061_754) do
  ...
  create_table 'dishes', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'picture'
    t.index %w[user_id created_at], name: 'index_dishes_on_user_id_and_created_at'
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id dish_id], name: 'index_favorites_on_user_id_and_dish_id', unique: true
  end
